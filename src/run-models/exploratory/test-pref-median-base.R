...
fd <- readRDS(here::here("data/test-median-pref/prefonmedian-0.898.rds"))
stan_data <- prepare_stan_data_no_pref(fd)
...
saveRDS(stan_fit_median_no_pref,here::here(paste0("outputs/test-pref-on-median-0524/modelbaseiters5k-",random_data_id,".rds")))
